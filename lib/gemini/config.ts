...
export const GEMINI_CONFIG = {
  ...
  apiKey: process.env.GOOGLE_GEMINI_API_KEY || 'AIzaSyC9Ut0-HNNkm2Bz3L5qGGz4uWZXvJEs1pM',
  ...
  models: {
    ...
    tts: 'gemini-2.0-flash-exp'   // Modelo para generar audio
  },
...
export const calculateGeminiCost = (tokens: number, operation: 'chat' | 'tts'): number => {
